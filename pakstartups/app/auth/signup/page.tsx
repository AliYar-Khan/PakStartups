      ...
      <section className="w-full md:w-1/2 bg-[#f9f9ff] flex items-center justify-center px-6 py-12 md:px-12">
        <div className="w-full max-w-[400px]">
          ...
          <header className="mb-10">
            ...
            <p className="text-[#404943] font-medium">Create an account to connect, learn, and build.</p>
          </header>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            <div>
              <label className="block text-xs font-bold text-[#404943] mb-2 ml-1" htmlFor="full-name">Full Name</label>
              <input
                id="full-name"
                type="text"
                value={fullName}
            ...
            >
              {loading ? (
                <><span className="inline-block w-4 h-4 border-2 border-white/40 border-t-white rounded-full animate-spin" />Creating Account...</>
              ) : "Create Account"}
            </button>
          </form>
